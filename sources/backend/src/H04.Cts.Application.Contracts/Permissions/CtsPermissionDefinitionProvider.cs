...
public class CtsPermissionDefinitionProvider : PermissionDefinitionProvider
{
    public override void Define(IPermissionDefinitionContext context)
    {
        ...
        var mangCTSs = danhMucs.AddChild(CtsPermissions.DanhMucs.MangCTS, L("Permission:DanhMucs.MangCTS"));
        mangCTSs.AddChild(CtsPermissions.DanhMucs.MangCTSCreate, L("Permission:DanhMucs.MangCTS.Create"));
        mangCTSs.AddChild(CtsPermissions.DanhMucs.MangCTSEdit, L("Permission:DanhMucs.MangCTS.Edit"));
        mangCTSs.AddChild(CtsPermissions.DanhMucs.MangCTSDelete, L("Permission:DanhMucs.MangCTS.Delete"));
        #endregion
    }
