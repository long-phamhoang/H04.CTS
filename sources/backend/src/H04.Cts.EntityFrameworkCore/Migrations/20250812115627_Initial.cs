        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ToChucCapTrenId = table.Column<long>(type: "bigint", nullable: true),
                    TenToChuc = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    MaToChuc = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: true),
                    MaSoThue = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: true),
                    DiaChiThuCongVu = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    DienThoai = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: true),
                    MaQuanHeNganSach = table.Column<string>(type: "character varying(16)", maxLength: 16, nullable: true),
                    CapCoQuanId = table.Column<long>(type: "bigint", nullable: true),
                    SoNha = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                    TinhThanhPhoId = table.Column<long>(type: "bigint", nullable: true),
                    XaPhuongId = table.Column<long>(type: "bigint", nullable: true),
                    CoQuanPhuTrach = table.Column<string>(type: "character varying(256)", maxLength: 256, nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AppToChucs", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AppToChucs_AppToChucs_ToChucCapTrenId",
                        column: x => x.ToChucCapTrenId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppToChucs_CapCoQuanId",
                table: "AppToChucs",
                column: "CapCoQuanId");

            migrationBuilder.CreateIndex(
                name: "IX_AppToChucs_DienThoai",
                table: "AppToChucs",
                column: "DienThoai");

            migrationBuilder.CreateIndex(
                name: "IX_AppToChucs_MaQuanHeNganSach",
                table: "AppToChucs",
                column: "MaQuanHeNganSach");

            migrationBuilder.CreateIndex(
                name: "IX_AppToChucs_MaSoThue",
                table: "AppToChucs",
                column: "MaSoThue");

            migrationBuilder.CreateIndex(
                name: "IX_AppToChucs_MaToChuc",
                table: "AppToChucs",
                column: "MaToChuc",
                unique: true,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AppToChucs_TinhThanhPhoId",
                table: "AppToChucs",
                column: "TinhThanhPhoId");

            migrationBuilder.CreateIndex(
                name: "IX_AppToChucs_ToChucCapTrenId",
                table: "AppToChucs",
                column: "ToChucCapTrenId");

            migrationBuilder.CreateIndex(
                name: "IX_AppToChucs_TrangThai",
                table: "AppToChucs",
                column: "TrangThai");

            migrationBuilder.CreateIndex(
                name: "IX_AppToChucs_XaPhuongId",
                table: "AppToChucs",
                column: "XaPhuongId");
