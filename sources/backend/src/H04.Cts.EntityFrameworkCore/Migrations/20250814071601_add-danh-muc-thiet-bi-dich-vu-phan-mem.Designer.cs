...
namespace H04.Cts.Migrations
{
    ...
    [Migration("20250814071601_add-danh-muc-thiet-bi-dich-vu-phan-mem")]
    partial class adddanhmucthietbidichvuphanmem
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("H04.Cts.DanhMucs.LoaiThietBiDichVuPhanMem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<string>("MaLoaiThietBiDichVuPhanMem")
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)");

                    b.Property<string>("TenLoaiThietBiDichVuPhanMem")
                        .HasMaxLength(256)
                    ...
                    b.HasIndex("MaLoaiThietBiDichVuPhanMem")
                        .IsUnique()
                        .HasFilter("\"IsDeleted\" = false");

                    b.HasIndex("TenLoaiThietBiDichVuPhanMem");

                    b.HasIndex("TrangThai");

                    b.ToTable("AppLoaiThietBiDichVuPhanMems", (string)null);
                });

            modelBuilder.Entity("H04.Cts.DanhMucs.ThietBiDichVuPhanMem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("DiaChiIP1")
                        .HasColumnType("text");

                    b.Property<string>("DiaChiThuCongVu")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");
                    ...
                    b.Property<long>("LoaiThietBiDichVuPhanMemId")
                        .HasColumnType("bigint");

                    b.Property<string>("TenCoQuanToChuc")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");

                    b.Property<string>("TenThietBiDichVuPhanMem")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");
                    ...
                    b.HasIndex("DiaChiIP1");

                    b.HasIndex("DiaChiThuCongVu");

                    b.HasIndex("LoaiThietBiDichVuPhanMemId");

                    b.HasIndex("TenCoQuanToChuc");

                    b.HasIndex("TenThietBiDichVuPhanMem");

                    b.HasIndex("TinhThanhPhoId");

                    b.ToTable("AppThietBiDichVuPhanMems", (string)null);
                });
            ...
            modelBuilder.Entity("H04.Cts.Entities.DanhMucs.ToChuc", b =>
                {
                    ...
                    b.Property<long?>("CapCoQuanId")
                        .HasColumnType("bigint");

                    b.Property<string>("CoQuanPhuTrach")
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");
                    ...
                    b.Property<long?>("ToChucCapTrenId")
                        .HasColumnType("bigint");

                    b.Property<int>("TrangThai")
                        .HasColumnType("integer");

                    b.Property<long?>("XaPhuongId")
                        .HasColumnType("bigint");

                    b.HasKey("Id");

                    b.HasIndex("CapCoQuanId");

                    b.HasIndex("DienThoai");

                    b.HasIndex("MaQuanHeNganSach");
            ...
            modelBuilder.Entity("H04.Cts.DanhMucs.ThietBiDichVuPhanMem", b =>
                {
                    b.HasOne("H04.Cts.DanhMucs.LoaiThietBiDichVuPhanMem", "LoaiThietBiDichVuPhanMemFk")
                        .WithMany("ThietBiDichVuPhanMems")
                        .HasForeignKey("LoaiThietBiDichVuPhanMemId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("LoaiThietBiDichVuPhanMemFk");
                });

            modelBuilder.Entity("H04.Cts.Entities.DanhMucs.ToChuc", b =>
                {
                    b.HasOne("H04.Cts.Entities.DanhMucs.ToChuc", "ToChucCapTrenFk")
                        .WithMany("ToChucCapDuois")
            ...
            modelBuilder.Entity("H04.Cts.DanhMucs.LoaiThietBiDichVuPhanMem", b =>
                {
                    b.Navigation("ThietBiDichVuPhanMems");
                });
