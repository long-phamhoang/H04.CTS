...
namespace H04.Cts.Migrations
{
    ...
    [Migration("20250816165326_MakeNguoiTiepNhan_ToChuc_ManyToMany")]
    partial class MakeNguoiTiepNhan_ToChuc_ManyToMany
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AppOrganizationNguoiTiepNhan", b =>
                {
                    b.Property<long>("OrganizationId")
                        .HasColumnType("bigint");

                    b.Property<long>("NguoiTiepNhanId")
                        .HasColumnType("bigint");

                    b.HasKey("OrganizationId", "NguoiTiepNhanId");

                    b.HasIndex("NguoiTiepNhanId");

                    b.HasIndex("OrganizationId");

                    b.ToTable("AppOrganizationNguoiTiepNhans", (string)null);
                });

            modelBuilder.Entity("H04.Cts.Entities.DanhMucs.NguoiTiepNhan", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("SubmissionAddress")
                        .IsRequired()
                        .HasMaxLength(256)
                        .HasColumnType("character varying(256)");
                    ...
                    b.HasIndex("NoiCapCCCDId");

                    b.HasIndex("Phone");

                    b.HasIndex("Position");

                    b.ToTable("AppNguoiTiepNhans", (string)null);
                });

            modelBuilder.Entity("H04.Cts.Entities.DanhMucs.NoiCapCCCD", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("AppNoiCapCCCDs", (string)null);
                });
            ...
            modelBuilder.Entity("AppOrganizationNguoiTiepNhan", b =>
                {
                    b.HasOne("H04.Cts.Entities.DanhMucs.NguoiTiepNhan", null)
                        .WithMany()
                    ...
                    b.HasOne("H04.Cts.Entities.DanhMucs.ToChuc", null)
                        .WithMany()
            ...
            modelBuilder.Entity("H04.Cts.Entities.DanhMucs.NguoiTiepNhan", b =>
                {
                    b.HasOne("H04.Cts.Entities.DanhMucs.NoiCapCCCD", "NoiCapCCCDFk")
                        .WithMany()
                        .HasForeignKey("NoiCapCCCDId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.Navigation("NoiCapCCCDFk");
                });
